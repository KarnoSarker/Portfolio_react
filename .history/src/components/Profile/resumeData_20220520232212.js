...
export default {
    ...
    projects: [
        ...
        },
        {
            ...
            caption: 'A short description',
            description: 'Currently, you are visiting this website',
            link: [
                
                {link: 'https://karno.netlify.app/', icon: <LanguageIcon />},
                {link: 'https://github.com/KarnoSarker/Portfolio_react', icon: <GitHubIcon />},
