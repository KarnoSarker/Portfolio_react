...
export default {
    ...
    about: 'I am an experienced programmer who can find creative solutions to technical challenges, whilst at the same time designing a sleek and visually appealing websites. I have extensive knowledge of recog- nized technical standards and familiar with modern build practices. I am knowledgeable in OOP, JavaScript, HTML5, CSS3 and SQL. I am also proficient in ReactJS, NextJS and Redux.',
    ...
    projects: [
        {
            ...
            link: [
                {link: 'https://www.goole.com', icon: <TwitterIcon />},
                {link: 'https://www.goole.com', icon: <GitHubIcon />},
                {link: 'https://www.goole.com', icon: <LinkedInIcon />},
            ],
        },
        {
            tag: 'Python',
